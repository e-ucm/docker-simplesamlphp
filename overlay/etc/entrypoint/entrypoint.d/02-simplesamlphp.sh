...
declare -x SIMPLESAMLPHP_ENABLE_GLOBAL
[[ -z "${SIMPLESAMLPHP_ENABLE_GLOBAL}" ]] && SIMPLESAMLPHP_ENABLE_GLOBAL=""

declare -x SIMPLESAMLPHP_ENABLE_VHOST
[[ -z "${SIMPLESAMLPHP_ENABLE_VHOST}" ]] && SIMPLESAMLPHP_ENABLE_VHOST=""
...
[[ -z "${SIMPLESAMLPHP_PATH}" ]] && SIMPLESAMLPHP_PATH="/$(echo ${SIMPLESAMLPHP_BASEURLPATH} | sed -E 's|^(https?://[^/]+)?/(.*)|\2|' | sed -E 's|(.*)/|\1|')"
...
[[ -z "${SIMPLESAMLPHP_SP_PRIVATE_KEY}" ]] && SIMPLESAMLPHP_SP_PRIVATE_KEY="${SIMPLESAMLPHP_SP_NAME}.key"

declare -x SIMPLESAMLPHP_SP_CERT
[[ -z "${SIMPLESAMLPHP_SP_CERT}" ]] && SIMPLESAMLPHP_SP_CERT="${SIMPLESAMLPHP_SP_NAME}.crt"
